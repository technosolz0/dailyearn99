...
class _WordLobbyScreenState extends State<WordLobbyScreen> {
  ...
  Widget _buildContestCard(
    ...
    final isCompleted =
        user?.completedWordContestIds?.contains(contest.id) ?? false;
                          ...
                          RichText(
                            text: const TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      'Sahi answer par +Points Reward (+100 pts) milta hai.\n',
                                ),
                                TextSpan(
                                ...
                                TextSpan(
                                  text:
                                      'Agar sawal 15 seconds ke under solve kiya, toh +50 bonus points add honge.\n',
                                ),
                                TextSpan(
                                  text: '• Penalty Rules: ',
                                  style: TextStyle(
                                ...
                                TextSpan(
                                  text:
                                      'Galat answer submit karne par -10 points penalty lagti hai aur hint use karne par -20 points penalty lagti hai.\n',
                                ),
                                TextSpan(
                                  text: '• Session End: ',
                                  style: TextStyle(
                                ...
                                TextSpan(
                                  text:
                                      'Sabhi questions attempt ho jane par ya time khatam hone par attempt "SUBMITTED" ho jata hai.',
                                ),
                              ],
                            ),
                          ),
        ...
        .push(
          MaterialPageRoute(
            builder: (context) => BlocProvider(
              create: (context) =>
                  WordPuzzleBloc(_repository)
                    ..add(JoinWordContestEvent(contest.id)),
