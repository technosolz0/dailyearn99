...
class _RegisterScreenState extends State<RegisterScreen> {
            ...
            child: Center(
              child: SingleChildScrollView(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: !_otpSent
                      ? _buildDetailsInputView(context)
  ...
  // ── Details Input View ─────────────────────────────────────────────────────
  Widget _buildDetailsInputView(BuildContext context) {
    return Column(
      key: const ValueKey("details_input_view"),
      mainAxisAlignment: MainAxisAlignment.center,
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        // Brand Register Logo Accent
        Center(
          child: Column(
            children: [
              Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Fill in your details below to secure your user profile.',
                  style: GoogleFonts.inter(
                    fontSize: 12.5,
                    color: AppTheme.textMuted,
                  ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Back Link to change registration details
                Center(
                  child: TextButton(
                    onPressed: () {
                      FocusManager.instance.primaryFocus?.unfocus();
